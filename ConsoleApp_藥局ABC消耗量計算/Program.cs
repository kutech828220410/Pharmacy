...
namespace ConsoleApp_藥局ABC消耗量計算
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            System.Data.DataTable dataTable_ABC_Buf;
            ...
            List<object[]> list_ABC_buf = new List<object[]>();
            int index = 0;
            ...
            Dictionary<string, List<medClass>> keyValuePairs_pharma_med = medClasses.CoverToDictionaryByCode();
            ...
            for (int i = 0; i < list_ABC.Count; i++)
            {
                ...
                medClasses_buf = keyValuePairs_pharma_med.SortDictionaryByCode(藥碼);
                    ...
                    || (安全量.StringToInt32() == 0 && 基準量.StringToInt32() == 0))
                {
                    ...
                    {
                        value_temp[(int)enum_異常安全基準量報表.類別] = medClasses_buf[0].類別;
                        list_ABC[i][(int)enum_ABC報表.類別] = medClasses_buf[0].類別;
                        list_異常安全基準量.Add(value_temp);
                        list_ABC_buf.Add(list_ABC[i]);
                    }
            ...
            dataTable = list_ABC_buf.ToDataTable(new enum_ABC報表());

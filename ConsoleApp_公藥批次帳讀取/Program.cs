...
namespace ConsoleApp_公藥批次帳讀取
{
    class Program
    {
        ...
        static string[] fileNames = new string[] { "DIMR2GF1_[Date].TXT", "DIMR2GB1_[Date].TXT" };//消耗帳1-2
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                dateTime = "2025-03-18".StringToDateTime();
                bool isNewInstance;
                ...
                using (System.Threading.Mutex mutex = new System.Threading.Mutex(true, applicationName, out isNewInstance))
                {
                    if (isNewInstance)
                    {
                        ...
                        sQLControl_過帳明細.TableName = "posting_sd0_public";

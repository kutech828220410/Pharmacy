...
namespace 智能藥庫系統_VM_Server_
{
    public partial class Form1 : Form
    {
        ...
        private void sub_Program_藥局_藥品資料_Init()
        {
            ...
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(100, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.藥品碼);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(280, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.中文名稱);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(280, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.藥品名稱);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(280, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.藥品學名);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.包裝單位);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.包裝數量);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.藥局庫存);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.藥庫庫存);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.總庫存);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.基準量);
            this.sqL_DataGridView_藥局_藥品資料.Set_ColumnWidth(90, DataGridViewContentAlignment.MiddleLeft, enum_medPharmacy.安全庫存);
        ...
        private void Function_藥局_藥品資料_檢查表格()
        {
            ...
            Parallel.ForEach(list_本地藥檔, value =>
            {
                ...
                list_藥品資料_buf = list_藥品資料.GetRows((int)enum_medPharmacy.藥品碼, value[(int)enum_本地_藥品資料.藥品碼].ObjectToString());
                object[] src_value = LINQ.CopyRow(value, new enum_本地_藥品資料(), new enum_medPharmacy());
            ...
            {
                List<object[]> list_本地藥檔_buf = list_本地藥檔.GetRows((int)enum_本地_藥品資料.藥品碼, value[(int)enum_medPharmacy.藥品碼].ObjectToString());

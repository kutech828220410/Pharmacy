...
namespace 智能藥庫系統
{
    public partial class Form1 : Form
    {
        ...
        private void SqL_DataGridView_周邊設備_ICU_ADC_01_庫存_交易紀錄查詢_DataGridRowsChangeRefEvent(ref List<object[]> RowsList)
        {
            ...
            list_value = list_value.GetRowsInDate((int)enum_周邊設備_庫存_交易紀錄查詢.操作時間, rJ_DatePicker_周邊設備_ICU_ADC_01_庫存_交易紀錄查詢_日期範圍_起始.Value, rJ_DatePicker_周邊設備_ICU_ADC_01_庫存_交易紀錄查詢_日期範圍_結束.Value);
        ...
        private void PlC_RJ_Button_周邊設備_ICU_ADC_01_庫存_交易紀錄查詢_匯出_MouseDownEvent(MouseEventArgs mevent)
        {
            this.Invoke(new Action(delegate
            {
                if (this.saveFileDialog_SaveExcel.ShowDialog() == DialogResult.OK)
                {
                    ...
                    DataTable dataTable = this.sqL_DataGridView_周邊設備_ICU_ADC_01_庫存_交易紀錄查詢.GetDataTable();
